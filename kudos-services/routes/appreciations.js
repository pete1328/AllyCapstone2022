...
const { addAppreciation, latestSentAppreciations, latestReceivedAppreciations, allAppreciations, weeklySentKudos, weeklyReceivedKudos } = require("../controllers/index");
...
router.get('/appreciations/weeklySent', weeklySentKudos)
router.get('/appreciations/weeklyReceived', weeklyReceivedKudos)
