...
const { createUser, validateUser, allManagers, allUsers, findEmail, findFirstName, updateSent, updateReceived, totalUsers, userCount, d3Nodes, userNameIDs, userIDs }  = require("../controllers/index");
