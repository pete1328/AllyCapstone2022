import { LoginButton, LogoutButton, ManagePointsButton, RedeemButton } from "../components/Button";
          ...
          <div className="w-full flex">
            <div className="w-full container bg-[#F0EFEF]">
              ...
              <div className=" pt-8 pb-8 w-fill flex items-center">
                <div className="border-[#9B9B9B] border-4 bg-white w-[80px] h-[80px] rounded-full ml-6"/>
                <div>
              ...
              <div className="flex pl-[106px] pr-[53px] -space-x-1">
                ...
                <div className="container bg-[#FFFFFF] border-[#D6D6D6] border-2">
                  <p>Spread some joy by appreciating someone</p>
                </div>
              </div>
            </div>
            <div className="w-[556px] container bg-[#FFFFFF]">
